...
\033[1;97m           
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : Shahmir Riddo 
\033[1;93m(!)\033[1;97m Github   : https://github.com/Ganjababa-SVG
\033[1;93m(!)\033[1;97m FB ID  : https://www.facebook.com/Riddo6
\033[1;93m(!)\033[1;97m Api Key  : CFBID11N0V20SPIDABMID11
\033[1;97m--------------------------------------------------
"""
...
def user_info():
	...
	print("")
        ...
        os.system("clear")
	print banner
	print("\033[1;93mThis Tool Is temporarily locked").center(50)
	print('')
	print("\033[1;93mPut the Api Key To Unlock This Tool").center(50)
	print('')
...
def login_fb():
	...
	time.sleep(3)
        ...
        print("")
        print("Email Or Password was Wrong").center(50)
	time.sleep(3)
        login_fb()
    else:
        print("")
        print("CheckPoint e porse id").center(50)
        print("")
        time.seelp(3)
	login_fb()
...
def choice_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;92[Successful] \033[1;96m"+uid+" | "+pass1+"\033[0;97m")
